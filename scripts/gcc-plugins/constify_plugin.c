...
static struct attribute_spec no_const_attr = ATTRIBUTE_SPEC_INIT("no_const", 0, 0, false, false, false, handle_no_const_attribute, true, NULL);
static struct attribute_spec do_const_attr = ATTRIBUTE_SPEC_INIT("do_const", 0, 0, false, false, false, handle_do_const_attribute, true, NULL);
