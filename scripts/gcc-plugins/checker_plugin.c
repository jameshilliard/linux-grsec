...
static struct attribute_spec context_attr = ATTRIBUTE_SPEC_INIT("context", 2, 3, true, false, false, handle_context_attribute, true, NULL);
...
//	e->probability = REG_BR_PROB_BASE;
	...
	e = make_edge(cond_bb, true_bb, EDGE_TRUE_VALUE);
	e->probability = REG_BR_PROB_EVEN;

	e = make_edge(true_bb, join_bb, EDGE_FALLTHRU);
	e->probability = REG_BR_PROB_EVEN;
