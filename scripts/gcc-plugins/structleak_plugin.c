...
// unused C type flag in all versions 4.5-7
...
static struct attribute_spec user_attr = ATTRIBUTE_SPEC_INIT("user", 0, 0, false, false, false, handle_user_attribute, true, NULL);
