...
#define PRINT_FN true
#define INSERT_FN false
...
extern bool check_fields, check_fns, check_fnptrs, check_vars, search_missing_fns;
...
extern const struct size_overflow_hash *get_size_overflow_hash_entry(struct fn_raw_data *raw_data, bool insert_print);
...
extern void __unused print_interesting_stmts(interesting_stmts_t cur);
