...
static void create_so_asm_stmt(struct asm_data *asm_data)
{
	...
	gimple_set_location(asm_stmt, gimple_location(asm_data->target_stmt));
	gimple_set_block(asm_stmt, gimple_block(asm_data->target_stmt));
...
static tree get_so_asm_input(struct asm_data *asm_data)
{
	...
	gimple_set_location(assign, gimple_location(asm_data->target_stmt));
	gimple_set_block(assign, gimple_block(asm_data->target_stmt));
