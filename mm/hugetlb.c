...
# if HUGE_MAX_HSTATE > 4
	[4] = CFTYPE_INIT(4),
# endif
# if HUGE_MAX_HSTATE > 5
	[5] = CFTYPE_INIT(5),
# endif
# if HUGE_MAX_HSTATE > 6
	[6] = CFTYPE_INIT(6),
# endif
# if HUGE_MAX_HSTATE > 7
	[7] = CFTYPE_INIT(7),
# endif
# if HUGE_MAX_HSTATE > 8
	[8] = CFTYPE_INIT(8),
# endif
# if HUGE_MAX_HSTATE > 9
	[9] = CFTYPE_INIT(9),
# endif
# if HUGE_MAX_HSTATE > 10
	[10] = CFTYPE_INIT(10),
# endif
# if HUGE_MAX_HSTATE > 11
	[11] = CFTYPE_INIT(11),
# endif
# if HUGE_MAX_HSTATE > 12
	[12] = CFTYPE_INIT(12),
# endif
# if HUGE_MAX_HSTATE > 13
	[13] = CFTYPE_INIT(13),
# endif
# if HUGE_MAX_HSTATE > 14
	[14] = CFTYPE_INIT(14),
# endif
# if HUGE_MAX_HSTATE > 15
