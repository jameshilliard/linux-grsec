...
#  define __ASM_RAP_RET_HASH(hash) .byte 0x48, 0xb8 ; .quad hash
# elif BITS_PER_LONG == 32
#  define __ASM_RAP_HASH(hash) .long 0, hash
#  define __ASM_RAP_RET_HASH(hash) .byte 0xb8 ; .long hash
# else
...
#else /* !__ASSEMBLY__*/
#ifdef CONFIG_PAX_RAP
#define RAP_HASH(name) __stringify(__ASM_RAP_HASH(__rap_hash_call_##name))
#else
#define RAP_HASH(name)
#endif
#endif
