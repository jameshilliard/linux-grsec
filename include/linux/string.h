...
size_t strlcpy_check(char *, const char *, size_t) __nocapture(2);
void strlcpy_nocheck(char *, const char *, size_t) __nocapture(2);
#define strlcpy strlcpy_nocheck
#else
#define strlcpy_check strlcpy
#endif
