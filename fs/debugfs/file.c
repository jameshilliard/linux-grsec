...
DEFINE_SIMPLE_ATTRIBUTE(fops_atomic_unchecked_t, debugfs_atomic_unchecked_t_get,
			debugfs_atomic_unchecked_t_set, "%lld\n");
DEFINE_SIMPLE_ATTRIBUTE(fops_atomic_unchecked_t_ro, debugfs_atomic_unchecked_t_get, NULL, "%lld\n");
DEFINE_SIMPLE_ATTRIBUTE(fops_atomic_unchecked_t_wo, NULL, debugfs_atomic_unchecked_t_set, "%lld\n");
...
{
	return debugfs_create_mode(name, mode, parent, value, &fops_atomic_unchecked_t,
					  &fops_atomic_unchecked_t_ro, &fops_atomic_unchecked_t_wo);
}
