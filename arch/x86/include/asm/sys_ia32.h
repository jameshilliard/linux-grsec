...
/* ia32/sys_ia32.c */
asmlinkage long compat_sys_x86_truncate64(const char __user *, unsigned int,
					  unsigned int);
asmlinkage long compat_sys_x86_ftruncate64(unsigned int, unsigned int,
					   unsigned int);
...
asmlinkage ssize_t compat_sys_x86_readahead(int, unsigned int, unsigned int,
					    size_t);
asmlinkage long compat_sys_x86_sync_file_range(int, unsigned, unsigned,
					       unsigned, unsigned,
					       int);
asmlinkage long compat_sys_x86_fadvise64(int, unsigned, unsigned,
					 int, int);
asmlinkage long compat_sys_x86_fallocate(int, int, unsigned, unsigned,
					 unsigned, unsigned);
